...
\begin{enumerate}
    \item If a SIG becomes dormant or fails to meet its expectations detailed in the \blockquote{SIG Handbook}, the CompSoc committee may place it under review for 3 months and require the submission of a remediation plan to avoid dissolution.
    \item The CompSoc committee shall reserve the right to dissolve a SIG by two-thirds majority vote if it remains dormant or non-compliant after a review period.
