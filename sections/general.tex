...
\begin{enumerate}
    \item Sponsorships here is considered to include partnerships
    ...
    \item When aware of a potential sponsorship, the Sponsors Team will make let the committee know this where permitting
    \item A sponsor may be deemed controversial with 1/3 of the committee in agreement.
    \item CompSoc must not take any sponsor deemed "controversial" without a 2/3 quorate committee vote.
    ...
    \begin{enumerate}
        ...
        \end{itemize}
        \item Sponsors \textbf{cannot} be deemed controversial solely for:
        \begin{itemize}
            \item Engaging in activism, promotion of or advocation of the interests of any group under protected characteristics.
