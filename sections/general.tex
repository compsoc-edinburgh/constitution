...
\begin{enumerate}
    ...
    \item Any report of sexual misconduct against student should be made via the University’s Report and Support website. The commitee must not take its own disciplinary action in these cases, but reserves the right to remove members from society events and spaces whilst reports are investigated.
