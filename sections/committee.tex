...
\begin{enumerate}
    ...
    \begin{itemize}
        \item Manage daily financial operations, such as making reimbursements and maintaining budgets
        \item Support the Treasurer as needed with financial operations
    \end{itemize}
    ...
    \end{itemize}
    \item The Academic Year Representatives (First Year, Second Year, Third Year, Fourth Year, Masters, ``Old Person'') shall:
    \begin{itemize}
