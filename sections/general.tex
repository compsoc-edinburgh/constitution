...
\subsection{Sponsorships and Partnerships}
\begin{enumerate}
    \item Sponsorships here is considered to include partnerships or any other form of collaboration.
    \item CompSoc may take academic and industry sponsors to financially support the society, as well as to provide events and networking.
    \item Sponsorships shall be the responsibility of the Sponsors Team - (including but not limited to the President, Vice President, Treasurer and Secretary).
    \item Sponsorships must be approved by the President and Vice President.
    \item When aware of a potential sponsorship, the Sponsors Team will inform the committee of this at the next committee meeting.
    \item If there is reason to believe a sponsor may be controversial, they may be deemed controversial with one-third of the committee in agreement.
    \item CompSoc must not take any sponsor deemed "controversial" without a two-thirds majority vote in favour of a quorate committee.
    \item The decision to take or not take a sponsor must be resolved within 2 meetings of the sponsor being deemed controversial.
    \begin{enumerate}
        \item Sponsors considered controversial are loosely understood as those that would raise internal and/or external opposition for political or ethical reasons.
        \item Sponsors considered controversial include but are not limited to:
        \begin{itemize}
            \item Sponsors involved in the defence industry.
            \item Sponsors involved in public controversies.
            \item Government bodies associated with defence, security, or immigration enforcement.
            \item Sponsors that may result in opposition from the wider student body.
        \end{itemize}
        \item Sponsors \textbf{cannot} be deemed controversial solely for engaging in activism, promotion of or advocation of the interests of any group under protected characteristics.
        \item If a sponsor could otherwise be considered controversial - as described above - they may still be deemed controversial.
        \item These characteristics are also enumarated under our Privacy, Equality and Accessibility policy.
        \item However, if a sponsors engages in discrimination against any of these characteristics they are certainly controversial.
    \end{enumerate}
    \item SIGs may take their own sponsors independently in accordance with the SIG Handbook.
\end{enumerate}
...
\begin{enumerate}
    ...
    \item The Students' Association has a Zero Tolerance policy for sexual harassment and violence.

    \item Any report of sexual misconduct against a student should be made via the University’s Report and Support website. The committee must not take its own disciplinary action in these cases, but reserves the right to remove members from society events and spaces whilst reports are investigated.

    \item For non-student members, these cases will be escalated to the final disciplinary stage (removal).
