...
\begin{enumerate}
    ...
    \item CompSoc must not take any sponsor considered "controversial" without a 2/3 quorate committee vote.
    ...
    \begin{enumerate}
        \item "Controversial" sponsors are loosely understood as those that would raise internal and/or external opposition for political or ethical reasons
        \item "Controversial" sponsors include but are not limited to:
        \begin{itemize}
        ...
        \end{itemize}
        \item Sponsors \textbf{cannot} be considered controversial for:
        \begin{itemize}
            \item Engaging in activism, promotion of or advocation of the interests of any group under protected characteristics.
            \item If a sponsor would otherwise be considered controversial they may still be deemed controversial.
